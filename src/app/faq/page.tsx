  ...
  return (
    <div id="faq" className="flex flex-col items-center mx-auto mt-[100px]">
      <div className="flex flex-col gap-5 pb-[100px]">
        ...
        <div className="font-bold flex flex-col gap-[80px] max-w-[1000px] w-[100vw] px-[30px]">
          {/* General Information */}
          <div className="grid">
            ...
            <label className="font-normal text-center mt-5 text-sm">
              ...
              David Liang at{" "}
              <a href={"David.liang@queensu.ca"}>David.liang@queensu.ca</a>
            </label>
          </div>
          ...
          <div className="grid">
            ...
            >
              <div>
                ...
                <br />
                <p>
                  To contact us directly regarding any issues with OpenJustice,
                  you may send your feedback to our Program Manager, David Liang
                  at{" "}
                  <a href="mailto:David.liang@queensu.ca">
                    David.liang@queensu.ca
                  </a>
